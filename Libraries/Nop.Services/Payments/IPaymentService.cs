...
namespace Nop.Services.Payments
{
    ...
    public partial interface IPaymentService
    {
        ...
        Task<decimal> CalculateAdditionalFee(IList<ShoppingCartItem> cart, object additionalFee, object additionalFeePercentage);
        //bool IsPaymentMethodActive(object value);
        ...
        Task<IPaymentMethod> LoadPaymentMethodBySystemName(string systemName);
        #endregion
    }
}
...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> ConfirmOrder(bool captchaValid, string existValid="true")
        {
            //validation
            if (_orderSettings.CheckoutDisabled)
                return RedirectToRoute("ShoppingCart");
            ...
            if ((isCaptchaSettingEnabled && !captchaValid && Convert.ToBoolean(existValid)) || Convert.ToBoolean(existValid))
            {
